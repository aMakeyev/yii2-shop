				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="<?= Url::home()?>"><?=Html::img('/frontend/web/images/home/logo.png', ['alt' => 'E-SHOPPER']) ?></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="<?= Url::to(['/cart/wishlist'])?>"><i class="fa fa-star"></i> Wishlist</a></li>
								<li><a href="<?= Url::to(['/cart/checkout'])?>"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								...
								<li><a href="<?= Url::to('/admin')?>"><i class="fa fa-lock admin-icon"></i>Админка</a></li>
								<?php endif;?>
								<?php if(Yii::$app->user->isGuest):?>
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="<?= Url::to(['/blog/index'])?>">Blog List</a></li>
										<li><a href="<?= Url::to(['/blog/view'])?>">Blog Single</a></li>
                                    </ul>
                                </li> 
								...
								<div class="video-gallery text-center">
									<a href="#">
										<!--<div class="embed-responsive embed-responsive-16by9">
											<iframe class="embed-responsive-item" src="/images/home/iframe1.png"></iframe>
										</div>-->
